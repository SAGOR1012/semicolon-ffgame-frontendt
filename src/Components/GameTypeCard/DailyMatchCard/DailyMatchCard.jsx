        ...
        <div className="bg-primary-bg-image p-2 pt-32 md:grid grid-cols-2 gap-10">
            ...
            <div className="rounded-lg bg-zinc-50  w-full mb-10">
                ...
                <div className="flex p-2">
                    ...
                    <div className="dropdown dropdown-bottom  border w-full ">
                        <div tabIndex={ 0 } role="button" className=" w-full p-1 flex gap-4 items-center font-bold md:text-sm   text-secondary border-2 border-secondary rounded-sm"> <span className="text-xl font-bold"><IoMdKey /></span>
                            Room Details <span className="md:text-sm "><AiFillCaretDown /></span>
                        </div>
                    ...
                    {/* Price details */ }
                    <div className=" dropdown dropdown-bottom  border w-full ">
                        <div tabIndex={ 0 } role="button" className=" w-full p-1 flex gap-1 items-center font-bold md:text-sm   text-secondary border-2 border-secondary rounded-sm"> <span className="text-xl font-bold"><LiaTrophySolid /></span>
                            Total Price Details <span className="md:text-sm "><AiFillCaretDown /></span>
                        </div>
                        <ul tabIndex={ 0 } className="dropdown-content menu bg-base-100 rounded-sm z-[1] w-52 p-2 shadow">
            ...
            <div className="rounded-lg bg-zinc-50  w-full mb-10">
                ...
                <div className="p-2 ">
                    ...
                    <div className="  flex justify-between gap-2">
                        <div className="flex  flex-col gap-3  w-full">
                            <progress className="  progress h-1 progress-warning rounded-none" value={ 48 } max="48"></progress>
                            <div className="text-pragraph flex justify-between">
                                <p className="font-extralight text-xs md:text-sm font-semibold">Only 00 spots left</p>
                                <p className="font-semibold">48/48</p>
                            </div>
                        </div>
                        {/* { <button className=" p-2 border-2 w-10/12 rounded-md border-secondary text-secondary font-bold md:text-sm ">Join</button> } */ }
                        {/* jodi full hoye jay tahole join dea jabe na */ }
