...
const Users = () => {
    return (
        <div className="py-32 bg-primary-bg-image px-2  md:flex justify-center">
            {/* Balance and ammount  */ }
            <div className="rounded-sm bg-white text-primary-content mb-10">
                <div className="stat">
                    ...
                    <div className="stat-actions flex gap-3 text-white">
                        ...
                        <button className=" p-2 border-2  rounded-md border-green-500 text-green-500 font-bold md:text-xl">Add Taka</button>
            ...
            <div className="rounded-md max-w-md p-8 flex  space-x-6 dark:bg-gray-50 dark:text-gray-800  ">
                {/* image */ }
